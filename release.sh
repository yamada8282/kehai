...
echo "--------------------------------------------------"
echo "✅ 準備完了！"
echo "以下の手順でGitHubにアップロードしてください:"
echo "1. GitHubにリポジトリ 'kehai' を作成する（まだの場合）"
echo "2. 'v$VERSION' というタグで Release を作成し、'$ZIP_NAME' をアップロードする"
echo "3. 'appcast.xml' と 'releasenotes.html' をリポジトリの main ブランチにプッシュする"
echo "--------------------------------------------------"
